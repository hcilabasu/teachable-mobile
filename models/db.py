...
db.define_table('problemBank',
    ...
    Field('robotLocation', type='string'))
    
## procedures database
## stores all procedures saved by the user or created by the developer
## going to start with this for now
db.define_table('procedures',
    Field('name', type='string', label=T('Procedure Name')),
    Field('parameters', type='list:string'),
    Field('displayLabel', type='string'),
